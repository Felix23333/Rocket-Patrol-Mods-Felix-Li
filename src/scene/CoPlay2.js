class CoPlay2 extends Phaser.Scene
{
    constructor()
    {
        super("Coplay2Scene");
    ...
    create()
    {
        ...
        this.rocket = new Rocket(this, game.config.width / 2, game.config.height - 45,
                                "rocket");
        this.p2rocket = new Rocket(this, game.config.width / 2 - 50, game.config.height - 45,
                                "p2Rocket");
        this.p2rocket.isP2 = true;
        ...
        p2LeftKey = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.LEFT);
        p2RightKey = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.RIGHT);
        p2ShootKey = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.ENTER);
        //animation
        this.anims.create({
            key: "explode", 
    ...
    update() 
    {
        ...
        this.checkcollision(this.p2rocket, this.rship);
    }
